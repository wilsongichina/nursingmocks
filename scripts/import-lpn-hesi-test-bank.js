...
const NESTED_SLUG = "hesi-lpn-exams";
const SITE_ORIGIN = "https://www.nursingmocks.com";
const APPLY = process.argv.includes("--apply");
const AUDIT = process.argv.includes("--audit");

const PARENT_ID_FALLBACK = "z0xzINtS3EohZNaKosBz";
const NESTED_ID_FALLBACK = "ToLSmb6DG83NTZWXEJxt";

const TOPICS = {
  Capstone: {
    slug: "hesi-lpn-capstone-practice-questions",
    pageName: "Capstone",
    metaTitle: "HESI LPN Capstone Questions | NursingMocks",
    description:
      "Prepare with HESI LPN Capstone questions for cumulative practical nursing review, readiness checks, and clinical judgment practice.",
  },
  "Fundamentals": {
    slug: "hesi-lpn-fundamentals-practice-questions",
    pageName: "Fundamentals",
    metaTitle: "HESI LPN Fundamentals Questions | NursingMocks",
    description:
      "Practice HESI LPN Fundamentals questions for basic nursing care, safety, infection control, nursing process, skills, and client care review.",
  },
  "Maternal Newborn": {
    slug: "hesi-lpn-maternal-newborn-practice-questions",
    pageName: "Maternal Newborn",
    metaTitle: "HESI LPN Maternal Newborn Questions | NursingMocks",
    description:
      "Practice HESI LPN Maternal Newborn questions for maternity, postpartum care, newborn care, pregnancy, labor, and practical nursing review.",
  },
  "Medical Surgical": {
    slug: "hesi-lpn-medical-surgical-practice-questions",
    pageName: "Medical Surgical",
    metaTitle: "HESI LPN Medical Surgical Questions | NursingMocks",
    description:
      "Practice HESI LPN Medical Surgical questions for adult care, disease processes, body systems, prioritization, and clinical judgment.",
  },
  "Pharmacology": {
    slug: "hesi-lpn-pharmacology-practice-questions",
    pageName: "Pharmacology",
    metaTitle: "HESI LPN Pharmacology Questions | NursingMocks",
    description:
      "Review HESI LPN Pharmacology questions on medication safety, drug classes, adverse effects, administration, and client teaching.",
  },
};
...
function buildTopicPayload(topicName, stats, now) {
  ...
  return {
    ...
    meta: {
      ...
      description: topic.description,
      keywords: `${topic.pageName}, HESI LPN practice questions, nursing test bank`,
...
function buildQuizPayload(row, sourceJson, questions, ids, now) {
  ...
  return {
    ...
    meta: {
      ...
      keywords: `${row.publicQuizTitle}, HESI LPN practice questions, nursing test bank`,
