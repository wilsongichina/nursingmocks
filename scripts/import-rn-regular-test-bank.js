...
const NESTED_SLUG = "rn-nursing-course-exams";
...
const NESTED_ID_FALLBACK = "zMFBI0XMiRsJnnXWhL5S";

const TOPICS = {
  "Adult Health": {
    slug: "rn-nursing-course-adult-health-practice-questions",
    pageName: "Adult Health",
    metaTitle: "RN Adult Health Course Exam Questions | NursingMocks",
    description:
      "Practice RN Adult Health course exam questions for adult-care concepts, clinical judgment, chronic illness, and medical-surgical review.",
  },
  "Anatomy and Physiology": {
    slug: "rn-nursing-course-anatomy-and-physiology-practice-questions",
    pageName: "Anatomy and Physiology",
    metaTitle: "RN Anatomy and Physiology Course Exam Questions | NursingMocks",
    description:
      "Review RN Anatomy and Physiology course exam questions for body systems, structure, function, and foundational nursing science.",
  },
  "Community Health": {
    slug: "rn-nursing-course-community-health-practice-questions",
    pageName: "Community Health",
    metaTitle: "RN Community Health Course Exam Questions | NursingMocks",
    description:
      "Review RN Community Health course exam questions for public health, epidemiology, prevention, health promotion, and community nursing.",
  },
  "Critical Care": {
    slug: "rn-nursing-course-critical-care-practice-questions",
    pageName: "Critical Care",
    metaTitle: "RN Critical Care Course Exam Questions | NursingMocks",
    description:
      "Practice RN Critical Care course exam questions for acute care, prioritization, hemodynamics, respiratory support, and complex clients.",
  },
  "Dimensions of Nursing Practice": {
    slug: "rn-nursing-course-dimensions-of-nursing-practice-practice-questions",
    pageName: "Dimensions of Nursing Practice",
    metaTitle: "RN Dimensions of Nursing Practice Questions | NursingMocks",
    description:
      "Practice RN Dimensions of Nursing Practice questions for professional nursing roles, clinical judgment, ethics, and care delivery.",
  },
  "Dosage Calculations": {
    slug: "rn-nursing-course-dosage-calculations-practice-questions",
    pageName: "Dosage Calculations",
    metaTitle: "RN Dosage Calculation Course Exam Questions | NursingMocks",
    description:
      "Practice RN dosage calculation course exam questions for medication math, conversions, safe administration, and calculation accuracy.",
  },
  "Endocrinology": {
    slug: "rn-nursing-course-endocrinology-practice-questions",
    pageName: "Endocrinology",
    metaTitle: "RN Endocrinology Course Exam Questions | NursingMocks",
    description:
      "Review RN Endocrinology course exam questions for endocrine disorders, diabetes care, hormone regulation, and nursing interventions.",
  },
  "Fundamentals": {
    slug: "rn-nursing-course-fundamentals-practice-questions",
    pageName: "Fundamentals",
    metaTitle: "RN Fundamentals Course Exam Questions | NursingMocks",
    description:
      "Practice RN Fundamentals course exam questions for safety, infection control, nursing process, skills, and foundational care.",
  },
  "Gastrointestinal System": {
    slug: "rn-nursing-course-gastrointestinal-system-practice-questions",
    pageName: "Gastrointestinal System",
    metaTitle: "RN Gastrointestinal System Course Exam Questions | NursingMocks",
    description:
      "Practice RN Gastrointestinal System course exam questions for GI disorders, assessment findings, procedures, and nursing care.",
  },
  "Growth and Development": {
    slug: "rn-nursing-course-growth-and-development-practice-questions",
    pageName: "Growth and Development",
    metaTitle: "RN Growth and Development Course Exam Questions | NursingMocks",
    description:
      "Review RN Growth and Development course exam questions for lifespan development, age-based care, milestones, and client teaching.",
  },
  "Health Assessment": {
    slug: "rn-nursing-course-health-assessment-practice-questions",
    pageName: "Health Assessment",
    metaTitle: "RN Health Assessment Course Exam Questions | NursingMocks",
    description:
      "Practice RN Health Assessment course exam questions on focused assessment, physical findings, documentation, and nursing observations.",
  },
  "Leadership": {
    slug: "rn-nursing-course-leadership-practice-questions",
    pageName: "Leadership",
    metaTitle: "RN Leadership Course Exam Questions | NursingMocks",
    description:
      "Practice RN Leadership course exam questions for delegation, prioritization, collaboration, safety, and nursing leadership decisions.",
  },
  "Maternal Newborn": {
    slug: "rn-nursing-course-maternal-newborn-practice-questions",
    pageName: "Maternal Newborn",
    metaTitle: "RN Maternal Newborn Course Exam Questions | NursingMocks",
    description:
      "Practice RN Maternal Newborn course exam questions for pregnancy, labor, postpartum care, newborn care, and maternal nursing review.",
  },
  "Medical Surgical": {
    slug: "rn-nursing-course-medical-surgical-practice-questions",
    pageName: "Medical Surgical",
    metaTitle: "RN Medical Surgical Course Exam Questions | NursingMocks",
    description:
      "Practice RN Medical Surgical course exam questions for adult health, disease processes, body systems, and clinical judgment.",
  },
  "Mental Health": {
    slug: "rn-nursing-course-mental-health-practice-questions",
    pageName: "Mental Health",
    metaTitle: "RN Mental Health Course Exam Questions | NursingMocks",
    description:
      "Study RN Mental Health course exam questions on psychiatric nursing, therapeutic communication, psychosocial care, and safety.",
  },
  "Microbiology": {
    slug: "rn-nursing-course-microbiology-practice-questions",
    pageName: "Microbiology",
    metaTitle: "RN Microbiology Course Exam Questions | NursingMocks",
    description:
      "Review RN Microbiology course exam questions for infection, pathogens, immune response, transmission, and nursing precautions.",
  },
  "Multidimensional Care": {
    slug: "rn-nursing-course-multidimensional-care-practice-questions",
    pageName: "Multidimensional Care",
    metaTitle: "RN Multidimensional Care Course Exam Questions | NursingMocks",
    description:
      "Practice RN Multidimensional Care course exam questions for integrated client care, clinical judgment, safety, and prioritization.",
  },
  "Nursing Specialty": {
    slug: "rn-nursing-course-nursing-specialty-practice-questions",
    pageName: "Nursing Specialty",
    metaTitle: "RN Nursing Specialty Course Exam Questions | NursingMocks",
    description:
      "Practice RN Nursing Specialty course exam questions for focused nursing specialty review, clinical judgment, and content-area readiness.",
  },
  "Nutrition": {
    slug: "rn-nursing-course-nutrition-practice-questions",
    pageName: "Nutrition",
    metaTitle: "RN Nutrition Course Exam Questions | NursingMocks",
    description:
      "Practice RN Nutrition course exam questions covering diet therapy, nutrients, client teaching, enteral support, and care planning.",
  },
  "Pathophysiology": {
    slug: "rn-nursing-course-pathophysiology-practice-questions",
    pageName: "Pathophysiology",
    metaTitle: "RN Pathophysiology Course Exam Questions | NursingMocks",
    description:
      "Review RN Pathophysiology course exam questions for disease mechanisms, clinical manifestations, complications, and nursing implications.",
  },
  "Pediatrics": {
    slug: "rn-nursing-course-pediatrics-practice-questions",
    pageName: "Pediatrics",
    metaTitle: "RN Pediatrics Course Exam Questions | NursingMocks",
    description:
      "Practice RN Pediatrics course exam questions for child health, development, family teaching, safety, and pediatric care.",
  },
  "Perfusion": {
    slug: "rn-nursing-course-perfusion-practice-questions",
    pageName: "Perfusion",
    metaTitle: "RN Perfusion Course Exam Questions | NursingMocks",
    description:
      "Practice RN Perfusion course exam questions for circulation, oxygenation, cardiovascular conditions, and priority nursing care.",
  },
  "Pharmacology": {
    slug: "rn-nursing-course-pharmacology-practice-questions",
    pageName: "Pharmacology",
    metaTitle: "RN Pharmacology Course Exam Questions | NursingMocks",
    description:
      "Review RN Pharmacology course exam questions on medication safety, drug classes, adverse effects, administration, and client teaching.",
  },
};
...
function buildTopicPayload(topicName, stats, now) {
  ...
  return {
    ...
    meta: {
      ...
      description: topic.description,
      keywords: `${topic.pageName}, RN nursing course practice questions, nursing test bank`,
...
function buildQuizPayload(row, sourceJson, questions, ids, now) {
  ...
  return {
    ...
    meta: {
      ...
      keywords: `${row.publicQuizTitle}, RN nursing course practice questions, nursing test bank`,
