...
const GROUP_SLUG = "lpn-regular";
const PILLAR_ID = "nursing-test-bank";
const PARENT_SLUG = "lpn-exams";
const NESTED_SLUG = "lpn-nursing-course-exams";
...
const NESTED_ID_FALLBACK = "3K3wv7IGcDcXvSNM9Kxm";

const TOPICS = {
  "Dosage Calculations": {
    slug: "lpn-nursing-course-dosage-calculations-practice-questions",
    pageName: "Dosage Calculations",
    metaTitle: "LPN Dosage Calculation Course Exam Questions | NursingMocks",
    description:
      "Practice LPN dosage calculation course exam questions for medication math, conversions, safe administration, and calculation accuracy.",
  },
  "Fundamentals": {
    slug: "lpn-nursing-course-fundamentals-practice-questions",
    pageName: "Fundamentals",
    metaTitle: "LPN Fundamentals Course Exam Questions | NursingMocks",
    description:
      "Practice LPN Fundamentals course exam questions for basic nursing care, safety, infection control, nursing process, skills, and client care review.",
  },
  "Health Assessment": {
    slug: "lpn-nursing-course-health-assessment-practice-questions",
    pageName: "Health Assessment",
    metaTitle: "LPN Health Assessment Course Exam Questions | NursingMocks",
    description:
      "Practice LPN Health Assessment course exam questions on focused assessment, physical findings, documentation, and practical nursing observations.",
  },
  "Leadership": {
    slug: "lpn-nursing-course-leadership-practice-questions",
    pageName: "Leadership",
    metaTitle: "LPN Leadership Course Exam Questions | NursingMocks",
    description:
      "Practice LPN Leadership course exam questions for delegation, prioritization, collaboration, safety, and practical nursing leadership decisions.",
  },
  "Medical Surgical": {
    slug: "lpn-nursing-course-medical-surgical-practice-questions",
    pageName: "Medical Surgical",
    metaTitle: "LPN Medical Surgical Course Exam Questions | NursingMocks",
    description:
      "Practice LPN Medical Surgical course exam questions for adult health, disease processes, body systems, and clinical judgment.",
  },
};
...
function buildTopicPayload(topicName, stats, now) {
  ...
  return {
    ...
    meta: {
      ...
      description: topic.description,
      keywords: `${topic.pageName}, LPN nursing course practice questions, nursing test bank`,
...
function buildQuizPayload(row, sourceJson, questions, ids, now) {
  ...
  return {
    ...
    meta: {
      ...
      keywords: `${row.publicQuizTitle}, LPN nursing course practice questions, nursing test bank`,
  ...
  return previewRows
    ...
    .map((row) => {
      ...
      return {
        ...
        destinationPath: manifest.destinationPath || resolveDestinationPath(row, cleanupRoot),
      };
    });
}
