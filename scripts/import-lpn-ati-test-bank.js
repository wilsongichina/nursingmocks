...
const PARENT_ID_FALLBACK = "z0xzINtS3EohZNaKosBz";
const NESTED_ID_FALLBACK = "lyrHg4RBzN6UafuymMFT";

const TOPICS = {
  "Adult Medical Surgical": {
    slug: "ati-pn-adult-medical-surgical-practice-questions",
    pageName: "Adult Medical Surgical",
    metaTitle: "ATI PN Adult Medical Surgical Questions | NursingMocks",
    description:
      "Practice ATI PN Adult Medical Surgical questions for med surg review, adult-care concepts, body systems, and clinical decision-making.",
  },
  "Anatomy and Physiology": {
    slug: "ati-pn-anatomy-and-physiology-practice-questions",
    pageName: "Anatomy and Physiology",
    metaTitle: "ATI PN Anatomy and Physiology Questions | NursingMocks",
    description:
      "Review ATI PN anatomy and physiology questions for body systems, normal function, terminology, and nursing science foundations.",
  },
  "Comprehensive Review": {
    slug: "ati-pn-comprehensive-review-practice-questions",
    pageName: "Comprehensive Review",
    metaTitle: "ATI PN Comprehensive Review Questions | NursingMocks",
    description:
      "Prepare with ATI PN comprehensive review questions for mixed nursing content, capstone practice, readiness checks, and clinical judgment.",
  },
  "Dosage Calculations": {
    slug: "ati-pn-dosage-calculations-practice-questions",
    pageName: "Dosage Calculations",
    metaTitle: "ATI PN Dosage Calculation Questions | NursingMocks",
    description:
      "Practice ATI PN dosage calculation questions for medication math, safe administration, conversions, and content-area assessments.",
  },
  "Fundamentals": {
    slug: "ati-pn-fundamentals-practice-questions",
    pageName: "Fundamentals",
    metaTitle: "ATI PN Fundamentals Practice Questions | NursingMocks",
    description:
      "Practice ATI PN Fundamentals questions for basic nursing care, safety, mobility, infection control, nursing process, and skills review.",
  },
  "Gerontology": {
    slug: "ati-pn-gerontology-practice-questions",
    pageName: "Gerontology",
    metaTitle: "ATI PN Gerontology Practice Questions | NursingMocks",
    description:
      "Review ATI PN Gerontology questions for older-adult assessment, chronic care, medication concerns, safety, and nursing support.",
  },
  "Health Assessment": {
    slug: "ati-pn-health-assessment-practice-questions",
    pageName: "Health Assessment",
    metaTitle: "ATI PN Health Assessment Questions | NursingMocks",
    description:
      "Practice ATI PN Health Assessment questions on focused assessment, physical findings, documentation, and observation skills.",
  },
  "Management": {
    slug: "ati-pn-management-practice-questions",
    pageName: "Management",
    metaTitle: "ATI PN Management Practice Questions | NursingMocks",
    description:
      "Review ATI PN Management practice questions for delegation, prioritization, care coordination, safety, and nursing leadership decisions.",
  },
  "Maternal Newborn": {
    slug: "ati-pn-maternal-newborn-practice-questions",
    pageName: "Maternal Newborn",
    metaTitle: "ATI PN Maternal Newborn Questions | NursingMocks",
    description:
      "Practice ATI PN Maternal Newborn questions for maternity, OB, postpartum care, newborn care, and practical nursing exam review.",
  },
  "Mental Health": {
    slug: "ati-pn-mental-health-practice-questions",
    pageName: "Mental Health",
    metaTitle: "ATI PN Mental Health Practice Questions | NursingMocks",
    description:
      "Study ATI PN Mental Health practice questions on psychiatric nursing, therapeutic communication, psychosocial care, and safety.",
  },
  "Microbiology": {
    slug: "ati-pn-microbiology-practice-questions",
    pageName: "Microbiology",
    metaTitle: "ATI PN Microbiology Practice Questions | NursingMocks",
    description:
      "Review ATI PN Microbiology questions for infection, organisms, transmission, prevention, and nursing science foundations.",
  },
  "Nutrition": {
    slug: "ati-pn-nutrition-practice-questions",
    pageName: "Nutrition",
    metaTitle: "ATI PN Nutrition Practice Questions | NursingMocks",
    description:
      "Practice ATI PN Nutrition questions covering diet therapy, nutrients, client teaching, enteral support, and nursing care planning.",
  },
  "Pediatric Nursing": {
    slug: "ati-pn-pediatric-nursing-practice-questions",
    pageName: "Pediatric Nursing",
    metaTitle: "ATI PN Pediatric Nursing Questions | NursingMocks",
    description:
      "Practice ATI PN Pediatric Nursing questions for child health, growth and development, family teaching, safety, and pediatric care.",
  },
  "Pharmacology": {
    slug: "ati-pn-pharmacology-practice-questions",
    pageName: "Pharmacology",
    metaTitle: "ATI PN Pharmacology Practice Questions | NursingMocks",
    description:
      "Review ATI PN Pharmacology practice questions on medication safety, drug classes, adverse effects, administration, and client teaching.",
  },
};

const LEGACY_TOPIC_NAMES = new Map(
  Object.keys(TOPICS).map((topicName) => [`PN ${topicName}`, topicName])
);
...
function buildTopicPayload(topicName, stats, now) {
  ...
  return {
    ...
    meta: {
      ...
      description: topic.description,
      keywords: `${topic.pageName}, ATI PN practice questions, nursing test bank`,
...
function buildQuizPayload(row, sourceJson, questions, ids, now) {
  ...
  return {
    ...
    meta: {
      ...
      keywords: `${row.publicQuizTitle}, ATI PN practice questions, nursing test bank`,
...
async function main() {
  ...
  if (APPLY) {
    ...
    for (const item of items) {
      ...
      const existingState = await getExistingQuizState(target, topicInfo, item);
      if (existingState?.complete) {
        summary.imported.push({
          ...
          slug: item.row.slug,
          quizId: existingState.quizId,
          action: "skipped-complete",
          questionCount: existingState.questionCount,
        });
        if (index % 10 === 0) {
          console.log(`Checked ${index}/${items.length} quizzes; complete quizzes are being skipped...`);
        }
        continue;
      }
