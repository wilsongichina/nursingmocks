...
foreach ($line in $lines) {
  ...
  } elseif ($line -eq "Start ATI TEAS English Practice") {
...
$zipPath = Join-Path $workspaceOutDir "english-humanized-package.zip"
if (Test-Path -LiteralPath $zipPath) {
  Remove-Item -LiteralPath $zipPath -Force
}

$tmpPackage = Join-Path $workspaceOutDir "english-docx-package"
