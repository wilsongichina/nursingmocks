...
const NESTED_ID_FALLBACK = "iT55qp9NAFOvZLBAiQzC";

const TOPICS = {
  "Adult Health": {
    slug: "hesi-rn-adult-health-practice-questions",
    pageName: "Adult Health",
    metaTitle: "HESI RN Adult Health Questions | NursingMocks",
    description:
      "Practice HESI RN Adult Health questions for adult-care concepts, clinical judgment, chronic illness, and medical-surgical review.",
  },
  "Biology": {
    slug: "hesi-rn-biology-practice-questions",
    pageName: "Biology",
    metaTitle: "HESI RN Biology Questions | NursingMocks",
    description:
      "Review HESI RN Biology questions for core science concepts, cells, body systems, and nursing entrance or support science review.",
  },
  "Capstone": {
    slug: "hesi-rn-capstone-practice-questions",
    pageName: "Capstone",
    metaTitle: "HESI RN Capstone Questions | NursingMocks",
    description:
      "Prepare with HESI RN Capstone questions for mixed nursing review, readiness checks, and cumulative clinical judgment practice.",
  },
  "CAT": {
    slug: "hesi-rn-cat-practice-questions",
    pageName: "CAT",
    metaTitle: "HESI RN CAT Questions | NursingMocks",
    description:
      "Practice HESI RN CAT questions for adaptive-style nursing review, mixed content, prioritization, and clinical decision-making.",
  },
  "Community Health": {
    slug: "hesi-rn-community-health-practice-questions",
    pageName: "Community Health",
    metaTitle: "HESI RN Community Health Questions | NursingMocks",
    description:
      "Review HESI RN Community Health questions for public health, epidemiology, prevention, health promotion, and community nursing.",
  },
  "Dosage Calculations": {
    slug: "hesi-rn-dosage-calculations-practice-questions",
    pageName: "Dosage Calculations",
    metaTitle: "HESI RN Dosage Calculation Questions | NursingMocks",
    description:
      "Practice HESI RN dosage calculation questions for medication math, conversions, safe administration, and calculation accuracy.",
  },
  "Fundamentals": {
    slug: "hesi-rn-fundamentals-practice-questions",
    pageName: "Fundamentals",
    metaTitle: "HESI RN Fundamentals Questions | NursingMocks",
    description:
      "Practice HESI RN Fundamentals questions for safety, infection control, nursing process, skills, and foundational care.",
  },
  "Health Assessment": {
    slug: "hesi-rn-health-assessment-practice-questions",
    pageName: "Health Assessment",
    metaTitle: "HESI RN Health Assessment Questions | NursingMocks",
    description:
      "Practice HESI RN Health Assessment questions on focused assessment, physical findings, documentation, and nursing observations.",
  },
  "Information Technology in Nursing": {
    slug: "hesi-rn-information-technology-in-nursing-practice-questions",
    pageName: "Information Technology in Nursing",
    metaTitle: "HESI RN Information Technology in Nursing Questions | NursingMocks",
    description:
      "Review HESI RN information technology questions for documentation, informatics, electronic health records, and nursing practice.",
  },
  "Leadership": {
    slug: "hesi-rn-leadership-practice-questions",
    pageName: "Leadership",
    metaTitle: "HESI RN Leadership Questions | NursingMocks",
    description:
      "Practice HESI RN Leadership questions for delegation, prioritization, collaboration, safety, and nursing leadership decisions.",
  },
  "Management": {
    slug: "hesi-rn-management-practice-questions",
    pageName: "Management",
    metaTitle: "HESI RN Management Questions | NursingMocks",
    description:
      "Review HESI RN Management questions for care coordination, delegation, leadership, prioritization, and client safety.",
  },
  "Maternity": {
    slug: "hesi-rn-maternity-practice-questions",
    pageName: "Maternity",
    metaTitle: "HESI RN Maternity Questions | NursingMocks",
    description:
      "Practice HESI RN Maternity questions for pregnancy, labor, postpartum care, newborn care, and maternal nursing review.",
  },
  "Medical Surgical": {
    slug: "hesi-rn-medical-surgical-practice-questions",
    pageName: "Medical Surgical",
    metaTitle: "HESI RN Medical Surgical Questions | NursingMocks",
    description:
      "Practice HESI RN Medical Surgical questions for adult health, disease processes, body systems, and clinical judgment.",
  },
  "Mental Health": {
    slug: "hesi-rn-mental-health-practice-questions",
    pageName: "Mental Health",
    metaTitle: "HESI RN Mental Health Questions | NursingMocks",
    description:
      "Study HESI RN Mental Health questions on psychiatric nursing, therapeutic communication, psychosocial care, and safety.",
  },
  "Milestones": {
    slug: "hesi-rn-milestones-practice-questions",
    pageName: "Milestones",
    metaTitle: "HESI RN Milestones Questions | NursingMocks",
    description:
      "Review HESI RN Milestones questions for growth, development, age-based care, and expected client development.",
  },
  "Nursing Research": {
    slug: "hesi-rn-nursing-research-practice-questions",
    pageName: "Nursing Research",
    metaTitle: "HESI RN Nursing Research Questions | NursingMocks",
    description:
      "Practice HESI RN Nursing Research questions for evidence-based practice, study design, data interpretation, and research concepts.",
  },
  "Nutrition": {
    slug: "hesi-rn-nutrition-practice-questions",
    pageName: "Nutrition",
    metaTitle: "HESI RN Nutrition Questions | NursingMocks",
    description:
      "Practice HESI RN Nutrition questions covering diet therapy, nutrients, client teaching, enteral support, and care planning.",
  },
  "Pathophysiology": {
    slug: "hesi-rn-pathophysiology-practice-questions",
    pageName: "Pathophysiology",
    metaTitle: "HESI RN Pathophysiology Questions | NursingMocks",
    description:
      "Review HESI RN Pathophysiology questions for disease mechanisms, clinical manifestations, complications, and nursing implications.",
  },
  "Pediatric Nursing": {
    slug: "hesi-rn-pediatric-nursing-practice-questions",
    pageName: "Pediatric Nursing",
    metaTitle: "HESI RN Pediatric Nursing Questions | NursingMocks",
    description:
      "Practice HESI RN Pediatric Nursing questions for child health, development, family teaching, safety, and pediatric care.",
  },
  "Pharmacology": {
    slug: "hesi-rn-pharmacology-practice-questions",
    pageName: "Pharmacology",
    metaTitle: "HESI RN Pharmacology Questions | NursingMocks",
    description:
      "Review HESI RN Pharmacology questions on medication safety, drug classes, adverse effects, administration, and client teaching.",
  },
  "Specialty": {
    slug: "hesi-rn-specialty-practice-questions",
    pageName: "Specialty",
    metaTitle: "HESI RN Specialty Questions | NursingMocks",
    description:
      "Practice HESI RN Specialty questions for focused nursing specialty review, clinical judgment, and content-area readiness.",
  },
};
...
function buildTopicPayload(topicName, stats, now) {
  ...
  return {
    ...
    meta: {
      ...
      description: topic.description,
      keywords: `${topic.pageName}, HESI RN practice questions, nursing test bank`,
...
function buildQuizPayload(row, sourceJson, questions, ids, now) {
  ...
  return {
    ...
    meta: {
      ...
      keywords: `${row.publicQuizTitle}, HESI RN practice questions, nursing test bank`,
