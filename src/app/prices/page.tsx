...
import PricesPageSchema from "@/components/ui/PricesPageSchema";
      ...
      <Layout>
        ...
        <section className="gradient-bg text-white py-[1.25rem]">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div className="mb-8">
              <Breadcrumb
                items={[{ label: "Home", href: "/" }, { label: "Prices" }]}
            ...
            <div className="text-center">
              ...
              <p className="text-xl md:text-2xl mb-4 max-w-4xl mx-auto leading-relaxed">
                Receive high-quality, 100% original TEAS exam services every
                time. Get a price estimate for your prep in as little as 5
                minutes. For comprehensive study plans or full courses, you can
                opt to pay in affordable installments.
              </p>
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="text-center mb-16">
              ...
              <p className="text-xl text-gray-600 max-w-3xl mx-auto">
                ...
                All our services come with guaranteed results and flexible
                payment options.
              </p>
            </div>
            ...
            <div className="bg-gradient-to-r from-blue-600 to-blue-700 rounded-2xl p-12 text-white shadow-2xl">
              <div className="max-w-3xl mx-auto text-center">
                ...
                <p className="text-xl mb-8 opacity-90 leading-relaxed">
                  ...
                  flexible payment plans make quality TEAS preparation
