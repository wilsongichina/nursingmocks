...
function EditKbArticleContent({
  ...
  const loadContent = useCallback(async () => {
    ...
    try {
      ...
      const result = await getNursingTestBankKbArticle(
      ...
      if (result.success && result.data) {
        ...
        const initializedContent: KbArticleContent = {
          ...
          pillarId: pageData.pillarId || "nursing-test-bank",
        };
  ...
  const handleSave = async () => {
    ...
    try {
      ...
      const contentToSave: any = {
        ...
        pillarId: content.pillarId || "nursing-test-bank",
      ...
      if (result.success) {
        ...
        if (documentId !== resolvedParams.kbArticleId) {
          ...
          setTimeout(() => {
            router.push(
              `/admin/nursing-test-bank/kb-articles/${documentId}`
            );
          }, 1000);
        } else {
              ...
              <div className="admin-header-row">
                <div className="admin-header-copy">
                  <h1 className="admin-page-title">
                    Edit KB Article - Nursing Test Bank
                  </h1>
                  <p className="admin-body max-w-[720px]">
                    Edit a KB article for the Nursing Test Bank pillar. Define the
                ...
                <div className="admin-header-actions">
                  <Link href="/admin/nursing-test-bank" className="admin-button-secondary">
                    Back to Admin
                  </Link>
                  {resolvedParams?.kbArticleId && (
                    <Link
                  ...
                  <div>
                    <div className="mb-3.5">
                      ...
                      <input
                        ...
                        placeholder="kb article, nursing test bank"
                        className="admin-field"
                      />
                    </div>
