  ...
  const handleSave = async () => {
    ...
    try {
      ...
      const contentWithSlug = {
        ...
        seoSlug: content.seoSlug || baseSlug,
      };
            ...
            <div className="bg-white rounded-2xl p-8 shadow-lg">
              ...
              <div className="space-y-4">
                ...
                <div>
                  ...
                  <p className="text-xs text-gray-500 mt-1">
                    Only <strong>Published</strong> nested pages appear to
                    students.
                  </p>
                </div>
            ...
            <div className="bg-white rounded-2xl p-8 shadow-lg">
              ...
              <div className="bg-white rounded-2xl p-8 shadow-lg">
                ...
                <div>
                  ...
                  />
                  <p className="text-xs text-gray-500 mt-1">
                    Rich text content displayed on the page
                  </p>
                </div>
              </div>
                  ...
                  {content.trustIndicators.map((indicator, index) => (
                    ...
                    >
                      <div className="flex justify-between items-start mb-4">
                        ...
                        <button
                          onClick={() =>
                            removeArrayItem("trustIndicators", index)
                          }
                  ...
                  {content.privacyPricing.map((item, index) => (
                    ...
                    >
                      <div className="flex justify-between items-start mb-4">
                        ...
                        <button
                          onClick={() =>
                            removeArrayItem("privacyPricing", index)
                          }
                          className="text-red-600 hover:text-red-800 text-sm font-medium"
                        >
                          Remove
                ...
                <div className="space-y-4">
                  <div>
                    ...
                    <input
                      ...
                      onChange={(e) =>
                        updateContent("faq.title", e.target.value)
                      }
                      className="w-full px-4 py-3 border border-gray-300 rounded-xl focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:border-transparent transition-all duration-200 text-gray-900"
                    />
                  </div>
