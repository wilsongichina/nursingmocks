...
function EditNestedSubPageContent({
            ...
            <header className="flex justify-between items-start mb-4.5 gap-3 flex-wrap">
              <div>
                <h1 className="text-2xl font-semibold tracking-tight mb-1 text-[#202437]">
                  Edit Nested Page – Nursing Test Bank
                </h1>
                  ...
                  <div>
                    <div className="mb-3.5">
                      ...
                      <input
                        ...
                        placeholder="Nursing Fundamentals"
                    ...
                    <div className="mb-3.5">
                      ...
                      <input
                        ...
                        placeholder="Nursing Fundamentals Practice Questions & Study Guide"
                        className="w-full rounded-lg border border-[#e2e4f0] bg-[#f9f9ff] px-2.5 py-2.25 text-sm font-sans text-[#202437] outline-none transition-all focus:border-[#6a5cff] focus:shadow-[0_0_0_1px_rgba(91,76,255,0.35)] focus:bg-white"
                      />
                    </div>
                  </div>
                  ...
                  <div>
                    <div className="mb-3.5">
                      ...
                      <input
                        ...
                        placeholder="nursing-fundamentals-questions"
                        className="w-full rounded-lg border border-[#e2e4f0] bg-[#f9f9ff] px-2.5 py-2.25 text-sm font-sans text-[#202437] outline-none transition-all focus:border-[#6a5cff] focus:shadow-[0_0_0_1px_rgba(91,76,255,0.35)] focus:bg-white"
                      />
              ...
              <section className="bg-white rounded-2xl shadow-sm p-4.5 border border-[#e2e4f0]/90 mb-4.5">
                  ...
                  <div>
                    <div className="mb-3.5">
                      ...
                      <input
                        ...
                        placeholder="Nursing Fundamentals Practice"
                        className="w-full rounded-lg border border-[#e2e4f0] bg-[#f9f9ff] px-2.5 py-2.25 text-sm font-sans text-[#202437] outline-none transition-all focus:border-[#6a5cff] focus:shadow-[0_0_0_1px_rgba(91,76,255,0.35)] focus:bg-white"
                      />
                    </div>
                  </div>
                ...
                <div className="mb-3.5">
                  ...
                  <input
                    ...
                    placeholder="Nursing Fundamentals Practice Questions (Updated 2026)"
                    className="w-full rounded-lg border border-[#e2e4f0] bg-[#f9f9ff] px-2.5 py-2.25 text-sm font-sans text-[#202437] outline-none transition-all focus:border-[#6a5cff] focus:shadow-[0_0_0_1px_rgba(91,76,255,0.35)] focus:bg-white"
                  />
                </div>
                  ...
                  <div>
                    <div className="mb-3.5">
                      ...
                      <input
                        ...
                        placeholder="nursing test bank, nursing fundamentals, practice questions"
                        className="w-full rounded-lg border border-[#e2e4f0] bg-[#f9f9ff] px-2.5 py-2.25 text-sm font-sans text-[#202437] outline-none transition-all focus:border-[#6a5cff] focus:shadow-[0_0_0_1px_rgba(91,76,255,0.35)] focus:bg-white"
                      />
                    </div>
                    ...
                    <div className="mb-3.5">
                      ...
                      <input
                        ...
                        placeholder="https://www.nursingmocks.com/.../nursing-fundamentals-questions"
                        className="w-full rounded-lg border border-[#e2e4f0] bg-[#f9f9ff] px-2.5 py-2.25 text-sm font-sans text-[#202437] outline-none transition-all focus:border-[#6a5cff] focus:shadow-[0_0_0_1px_rgba(91,76,255,0.35)] focus:bg-white"
                      />
                    </div>
                  </div>
                  ...
                  <div>
                    ...
                    <div className="mb-3.5">
                      ...
                      <input
                        ...
                        placeholder="/images/og/nursing-fundamentals.png"
                        className="w-full rounded-lg border border-[#e2e4f0] bg-[#f9f9ff] px-2.5 py-2.25 text-sm font-sans text-[#202437] outline-none transition-all focus:border-[#6a5cff] focus:shadow-[0_0_0_1px_rgba(91,76,255,0.35)] focus:bg-white"
                      />
                      <div className="text-[11px] text-[#a0a5bf] mt-1">
  ...
  "@type": "Article",
  "headline": "Nursing Fundamentals Practice Questions & Study Guide",
