          ...
          <div className="w-full">
            ...
            <section className="grid grid-cols-1 lg:grid-cols-[3fr_2.2fr] gap-4.5 mb-1 items-start">
              <AdminCard
                ...
                description="Manage where this Sub Page sits in the Nursing Exit Exam structure and how it appears publicly."
              >
                  ...
                  <div className="grid grid-cols-1 sm:grid-cols-2 gap-2.5 mb-1">
                    <AdminInfoTile label="Pillar Page">
                      ...
                      <p className="admin-helper">
                        Root area for RN, LPN, NCLEX, and nursing exit exam content.
                      </p>
                    </AdminInfoTile>
                    ...
                    <div className="space-y-4">
                      ...
                      >
                        <input
                          ...
                          placeholder="rn exit exam practice, nclex review, nursing exit exam"
                          className="admin-field"
                        />
                      </AdminFieldGroup>
                    ...
                    <div className="space-y-4">
                      ...
                      >
                        <input
                          ...
                          placeholder="/images/og/rn-exit-exam.png"
                          className="admin-field"
                        />
                      </AdminFieldGroup>
                    </div>
