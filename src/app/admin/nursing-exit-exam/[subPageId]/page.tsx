      ...
      if (result.success && result.data) {
        ...
        const initializedContent: ServiceContent = {
          ...
          meta: {
            ...
            canonicalUrl: pageData.meta?.canonicalUrl || `https://teasgurus.com/nursing-exit-exam/${resolvedParams.subPageId}`,
          },
        ...
        const defaultContent: ServiceContent = {
          ...
          meta: {
            ...
            canonicalUrl: `https://teasgurus.com/nursing-exit-exam/${resolvedParams.subPageId}`,
          },
          schema: "",
          hero: {
            badge: "",
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between items-center py-6">
            ...
            <div className="flex flex-wrap gap-3">
              ...
              {resolvedParams?.subPageId && (
                <Link
                  href={`/nursing-exit-exam/${slug || resolvedParams.subPageId}`}
                  target="_blank"
              ...
              <button
                onClick={handleSave}
                disabled={saving}
                className="bg-gradient-to-r from-teal-600 to-blue-600 text-white px-6 py-2 rounded-lg hover:from-teal-700 hover:to-blue-700 transition-all duration-200 font-semibold shadow-lg hover:shadow-xl transform hover:-translate-y-0.5 disabled:opacity-50 disabled:transform-none flex items-center space-x-2"
              >
                {saving ? (
                  <>
            ...
            <div className="space-y-4">
              <div>
                ...
                <input
                  ...
                  className="w-full px-4 py-3 border border-gray-300 rounded-xl focus:outline-none focus:ring-2 focus:ring-teal-500 focus:border-transparent transition-all duration-200 text-gray-900"
                />
              </div>
              <div>
                <label className="block text-sm font-semibold text-gray-700 mb-2">
                ...
                <p className="text-xs text-gray-500 mt-1">
                  URL slug (editable). The URL will be: /nursing-exit-exam/[slug]
                </p>
              </div>
            </div>
          </div>
          ...
          <div className="bg-white rounded-2xl p-8 shadow-lg">
            ...
            <div>
              ...
              <textarea
                ...
                rows={12}
                className="w-full px-4 py-3 border border-gray-300 rounded-xl focus:outline-none focus:ring-2 focus:ring-teal-500 focus:border-transparent transition-all duration-200 text-gray-900 font-mono text-sm"
              />
            </div>
          </div>
