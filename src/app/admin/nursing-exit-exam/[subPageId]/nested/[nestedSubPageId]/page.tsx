...
function EditNestedSubPageContent({
  ...
  const loadContent = useCallback(async () => {
    ...
    try {
      ...
      const [result, parentResult] = await Promise.all([
        ...
        getNursingExitExamSubPage(resolvedParams.subPageId),
      ]);
          ...
          <AdminTopBar
            breadcrumbs={[
              ...
              { label: "Nursing Exit Exam", href: "/admin/nursing-exit-exam" },
              {
                ...
                href: resolvedParams
                  ? `/admin/nursing-exit-exam/${resolvedParams.subPageId}`
          ...
          <div className="w-full">
            ...
            <section className="grid grid-cols-1 lg:grid-cols-[3fr_2.2fr] gap-4.5 mb-1 items-start">
              <AdminCard
                ...
                description="Manage where this Nested Sub Page sits in the Nursing Exit Exam structure and how it appears publicly."
              >
                  ...
                  <div className="grid grid-cols-1 sm:grid-cols-2 gap-2.5 mb-1">
                    <AdminInfoTile label="Pillar Page">
                      ...
                      <p className="admin-helper">
                        Root area for NCLEX and nursing exit exam content.
                      </p>
                    </AdminInfoTile>
                    ...
                    <div className="space-y-4">
                      ...
                      >
                        <input
                          ...
                          placeholder="RN Exit Exam Practice Questions And Study Guide"
                          className="admin-field"
                        />
                      </AdminFieldGroup>
                    </div>
                    ...
                    <div className="space-y-4">
                      ...
                      >
                        <AdminSlugField
                          ...
                          placeholder="rn-exit-exam-practice-questions"
                        />
                      </AdminFieldGroup>
                ...
                >
                  <textarea
                    ...
                    placeholder="Practice exit exam question formats, clinical judgment, and explanations for nursing exit exam preparation."
                    rows={3}
                    maxLength={180}
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                    ...
                    >
                      <input
                        ...
                        placeholder="RN Exit Exam Practice"
                        className="admin-field"
                      />
                    </AdminFieldGroup>
                ...
                <AdminFormSection title="SEO Meta" className="mt-5">
                  ...
                  >
                    <input
                      ...
                      placeholder="RN Exit Exam Practice Questions (Updated 2026)"
                      className="admin-field"
                    />
                  </AdminFieldGroup>
                    ...
                    <div className="space-y-4">
                      ...
                      >
                        <input
                          ...
                          placeholder="teas reading practice, teas passages, nursing exit exam"
                          className="admin-field"
                        />
                      </AdminFieldGroup>
                      ...
                      >
                        <input
                          ...
                          placeholder="https://www.nursingmocks.com/.../rn-exit-exam-practice-questions"
                          className="admin-field"
                        />
                      </AdminFieldGroup>
                    </div>
  ...
  "@type": "Article",
  "headline": "RN Exit Exam Practice Questions And Study Guide",
