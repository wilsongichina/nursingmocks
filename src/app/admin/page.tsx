          ...
          >
            <div className="flex items-center mb-4">
              ...
              <div>
                ...
                <p className="text-sm text-gray-600">Manage support content</p>
              </div>
            </div>
            <p className="text-gray-600 text-sm">
              Edit FAQ pages, terms of service, privacy policy, and other
              support content.
            </p>
            <div className="mt-4 flex items-center text-green-600 group-hover:text-green-700 transition-colors">
              <span className="text-sm font-medium">Manage Support</span>
              <svg
                className="w-4 h-4 ml-2 group-hover:translate-x-1 transition-transform"
                fill="none"
                stroke="currentColor"
