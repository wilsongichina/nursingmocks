      ...
      <SidebarProvider>
        <LoadingShell>
          <AdminLoadingState
            ...
            description="Preparing the saved question, answer options, explanation, and metadata."
          />
        </LoadingShell>
      </SidebarProvider>
    );
    ...
    return (
      <div className="admin-page flex min-h-screen items-center justify-center px-4 py-6">
        <div className="admin-card max-w-md p-6 text-center">
          <h1 className="admin-section-title mb-2">Question not found</h1>
          <p className="admin-helper mb-4">This question may have been deleted or moved.</p>
          <Link
