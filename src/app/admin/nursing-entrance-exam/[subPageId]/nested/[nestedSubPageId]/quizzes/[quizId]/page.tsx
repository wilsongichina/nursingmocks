      ...
      if (result.success && result.data) {
        ...
        const initializedContent: ServiceContent = {
          ...
          meta: {
            ...
            canonicalUrl:
              ...
              `${process.env.NEXT_PUBLIC_SITE_URL || "https://teasgurus.com"}/${parentUrlSlug}-${currentNestedSlug}-questions/${
        ...
        const defaultContent: ServiceContent = {
          ...
          meta: {
            ...
            keywords: `${resolvedParams.quizId}, ${resolvedParams.nestedSubPageId}, ${resolvedParams.subPageId}, nursing entrance exam`,
            ogTitle: `${resolvedParams.quizId} | TeasGurus`,
            ogDescription: `Content for ${resolvedParams.quizId}`,
            ogImage: "/teas-gurus-logo.png",
            canonicalUrl: `${process.env.NEXT_PUBLIC_SITE_URL || "https://teasgurus.com"}/${resolvedParams.quizId}`,
          },
          schema: "",
          hero: {
            ...
            <div className="space-y-4">
              ...
              <div>
                ...
                <p className="text-xs text-gray-500 mt-1">
                  Slug (editable). The full URL slug will be: <span className="font-mono font-semibold">/{quizSlug || resolvedParams?.quizId || ""}</span>
                </p>
                <div className="mt-2 p-3 bg-gray-50 rounded-lg">
                  ...
                  <input
                    type="text"
                    value={quizSlug || resolvedParams?.quizId || ""}
                    readOnly
