    ...
    try {
      ...
      const defaultQuizContent = {
        ...
        meta: {
          ...
          canonicalUrl: `https://teasgurus.com/${parentUrlSlug}-${
            nestedSlug || resolvedParams.nestedSubPageId
          }-questions/${normalizedQuizId}`,
        },
        hero: {
          title: newQuizName,
        },
              ...
              <div>
                ...
                <div className="flex items-center space-x-2 flex-wrap gap-2">
                  <span className="text-sm text-gray-500 whitespace-nowrap">
                    https://teasgurus.com/{parentUrlSlug}-
                    {nestedSlug || resolvedParams.nestedSubPageId}-questions/
                  </span>
                  <input
                    type="text"
                    value={newQuizId}
                ...
                <p className="text-sm text-gray-500 mt-1 break-words">
                  This will create a quiz at /{parentUrlSlug}-
                  {nestedSlug || resolvedParams.nestedSubPageId}-questions/
                  {newQuizId || "quiz-id"}
                </p>
              </div>
