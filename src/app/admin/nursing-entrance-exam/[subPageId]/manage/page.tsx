            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
              {nestedSubPages.map((nestedSubPage) => (
                ...
                >
                  ...
                  <div className="mt-4">
                    <Link
                      href={`/${((slug || resolvedParams.subPageId).endsWith("-exam") ? (slug || resolvedParams.subPageId).slice(0, -5) : (slug || resolvedParams.subPageId))}-${nestedSubPage.slug || nestedSubPage.id}-questions`}
                      target="_blank"
                    ...
                    <p className="text-xs text-gray-500 mt-1">
                      URL: /{((slug || resolvedParams.subPageId).endsWith("-exam") ? (slug || resolvedParams.subPageId).slice(0, -5) : (slug || resolvedParams.subPageId))}-{nestedSubPage.slug || nestedSubPage.id}
                      -questions
                    </p>
                  </div>
                </div>
