            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
              {subPages.map((subPage) => (
                ...
                >
                  ...
                  <div className="mt-4">
                    <Link
                      href={`/${(subPage.slug || subPage.id).endsWith("-exam") ? (subPage.slug || subPage.id) : `${subPage.slug || subPage.id}-exam`}`}
                      target="_blank"
                      className="text-indigo-600 hover:text-indigo-800 text-sm font-medium"
                    >
                      View Page →
          ...
          <div className="bg-white rounded-2xl p-8 max-w-md w-full mx-4">
            ...
            <form onSubmit={handleCreateSubPage} className="space-y-4">
              ...
              <div>
                ...
                <p className="text-sm text-gray-500 mt-1">
                  This will create a page at /{newSubPageId || "sub-page-id"}-exam
                </p>
              </div>
