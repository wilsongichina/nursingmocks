...
export default function RichTextEditor({
  ...
  return (
    <div className={`admin-rich-text-shell ${className}`}>
      {/* Toolbar */}
      <div className="admin-editor-toolbar">
        <button
          type="button"
          onClick={() => execCommand("bold")}
          className="admin-editor-toolbar-button"
          title="Bold"
        >
          <svg className="admin-editor-toolbar-icon" fill="currentColor" viewBox="0 0 20 20">
        ...
        <div className="admin-editor-divider"></div>

        <button
          type="button"
          onClick={() => execCommand("formatBlock", "<h1>")}
          className="admin-editor-toolbar-button text-sm font-bold"
          title="Heading 1"
        >
          H1
        </button>
        ...
        <button
          ...
          className="admin-editor-toolbar-button text-sm"
          title="Paragraph"
        >
          P
        </button>
