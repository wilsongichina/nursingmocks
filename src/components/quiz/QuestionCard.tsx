...
export default function QuestionCard({
  ...
  return (
    <div className="bg-white border border-gray-200 rounded-xl p-8 lg:p-10 shadow-md hover:shadow-lg transition-all duration-300 relative">
      {/* Question Type Badge - Top Right */}
      <div className="absolute top-6 right-6 z-10">
        <span className="inline-flex items-center px-4 py-2 rounded-lg bg-indigo-100 text-indigo-800 text-xs font-semibold border border-indigo-200 shadow-sm">
          {questionTypeName}
        </span>
      </div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-5 gap-8 lg:gap-10">
        ...
        <div className="lg:col-span-2">
          ...
          {questionTypeId === 3 ? (
            ...
            <div className="space-y-4">
              {["True", "False"].map((option, optIndex) => {
                ...
                return (
                  ...
                  >
                    <span
                      className={`flex-shrink-0 w-10 h-10 rounded-xl flex items-center justify-center font-bold text-base shadow-sm ${
                        isCorrect
                    ...
                    <div className="flex-1 text-gray-800 font-medium text-base pt-1">
                      {option}
                    </div>
                    {isCorrect && (
                      <svg
            ...
            // Numeric/Fill-in
            <div>
              <div className="p-5 bg-green-50 border-2 border-green-300 rounded-xl shadow-sm">
                <div className="flex items-center gap-3">
                  <span className="flex-shrink-0 w-10 h-10 bg-green-500 text-white rounded-xl flex items-center justify-center font-bold text-base shadow-md">
                    ✓
                  </span>
                ...
                {options.map((option: string, optIndex: number) => {
                  ...
                  return (
                    ...
                    >
                      ...
                      <div className="flex-1 text-gray-800 text-base leading-relaxed pt-1">
          ...
          {question.explanation ? (
            <div className="lg:sticky lg:top-8 relative">
              ...
              <div className="flex items-start gap-3 mb-4 lg:mt-[2.75rem]">
                ...
                <h4 className="font-bold text-blue-900 text-lg">Rational/Explanation:</h4>
              </div>
              ...
              <div
                className={`p-6 bg-gradient-to-br from-blue-50 to-indigo-50 border-2 border-blue-200 rounded-xl shadow-md transition-all duration-300 ${
            ...
            <div className="lg:sticky lg:top-8 p-6 bg-gray-50 border-2 border-gray-200 rounded-xl text-center text-gray-500 text-base">
